...
/**
 * This is a very crude server that I wrote in a day. It only keeps record of clients and forwards
 * messages received to them all. If I had time, this could develop into a more fully fledged server
 * which allows multiple different games rather than only one that all clients have to play.
 * 
 * @author hja1g11
 * 
 */
